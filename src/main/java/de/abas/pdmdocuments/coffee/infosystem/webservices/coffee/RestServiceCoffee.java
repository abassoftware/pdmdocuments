package de.abas.pdmdocuments.coffee.infosystem.webservices.coffee;
...
import de.abas.pdmdocuments.coffee.infosystem.webservices.keytech.ChildLink;
import de.abas.pdmdocuments.coffee.infosystem.webservices.keytech.FileInfo;
import de.abas.pdmdocuments.coffee.infosystem.webservices.keytech.FileInfoList;
import de.abas.pdmdocuments.coffee.infosystem.webservices.keytech.PDMLinks;
...
public class RestServiceCoffee extends AbstractRestService {
	...
	private PDMLinks searchProductLinks(String pdmProductID) throws PdmDocumentsException {
		...
		try {
			...
			throw new PdmDocumentsException(
					Util.getMessage(PDM_DOCUMENT_RESTSERVICE_COFFEE_ERROR_JSON_TO_OBJECT, "PDMLink"), e);
		}
	...
	private List<FileInfo> getFileInfoList(ChildLink childLink) throws PdmDocumentsException {
		...
		try {
			...
			log.error(e);
			throw new PdmDocumentsException(
					Util.getMessage(PDM_DOCUMENT_RESTSERVICE_COFFEE_ERROR_JSON_TO_OBJECT, "FileInfoList"), e);
		}
